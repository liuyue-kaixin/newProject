      ...
      _export("InitResSystem", InitResSystem = (_dec2 = (_crd && ecs === void 0 ? (_reportPossibleCrUseOfecs({
        ...
        loadLanguage(queue) {
          queue.push((next, params, args) => {
            // 设置默认语言
            let lan = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
              error: Error()
        ...
        onComplete(queue, e) {
          queue.complete = async () => {
            var node = await (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
              error: Error()
...
//# sourceMappingURL=642b4cbb717044babc3fa7da85e849873f1423ca.js.map