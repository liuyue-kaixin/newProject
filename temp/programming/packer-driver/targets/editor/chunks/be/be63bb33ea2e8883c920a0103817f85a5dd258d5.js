    ...
    execute: function () {
      ...
      _export("LayerUI", LayerUI = class LayerUI extends Node {
        ...
        createNode(viewParams) {
          viewParams.valid = true;
          let comp = viewParams.node.getComponent(_crd && DelegateComponent === void 0 ? (_reportPossibleCrUseOfDelegateComponent({
            error: Error()
          }), DelegateComponent) : DelegateComponent);
          comp.add();
...
//# sourceMappingURL=be63bb33ea2e8883c920a0103817f85a5dd258d5.js.map