    ...
    execute: function () {
      ...
      _export("RotateUtil", RotateUtil = class RotateUtil {
        ...
        static circularEdgePosition(center, radius, angle) {
          let edge = (_crd && Vec3Util === void 0 ? (_reportPossibleCrUseOfVec3Util({
            error: Error()
          }), Vec3Util) : Vec3Util).z.multiplyScalar(radius); // 距离圆心Z抽的距离

          let dir = (_crd && Vec3Util === void 0 ? (_reportPossibleCrUseOfVec3Util({
            error: Error()
...
//# sourceMappingURL=35a53c878df796d68bcc2e0f6bc8207dc69a4a28.js.map