    ...
    execute: function () {
      ...
      _export("Player", Player = (_dec = ccclass('Player'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Player extends (_crd && cObject === void 0 ? (_reportPossibleCrUseOfcObject({
        ...
        start() {
          ...
          var joystick = (_crd && BulletHell === void 0 ? (_reportPossibleCrUseOfBulletHell({
            error: Error()
        ...
        onSkill() {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            var skill = (_crd && Skill === void 0 ? (_reportPossibleCrUseOfSkill({
              error: Error()
...
//# sourceMappingURL=406f032550562560073cb62c3fdb895ffa2d0c95.js.map