System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCInteger, Component, instantiate, Node, Prefab, Quat, Sprite, Vec2, Vec3, cCollider, Joystick, Bullet, Ghost, Player, SnailTail, Skill, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _crd, ccclass, property, tempPos, tempRot, BulletHell;
  ...
  function _reportPossibleCrUseOfJoystick(extras) {
    _reporterNs.report("Joystick", "../../Joystick/Joystick", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Ghost = _unresolved_5.Ghost;
    }, function (_unresolved_6) {
      Player = _unresolved_6.Player;
    }, function (_unresolved_7) {
      SnailTail = _unresolved_7.SnailTail;
    }, function (_unresolved_8) {
      Skill = _unresolved_8.Skill;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BulletHell", BulletHell = (_dec = ccclass('BulletHell'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(_crd && Joystick === void 0 ? (_reportPossibleCrUseOfJoystick({
        ...
        start() {
          ...
          this.schedule(() => {
            if (this.objects.children.length < this.max) {
              var x = (0.5 + a2 * i) % 1;
              var y = (0.5 + a1 * i) % 1;
              var center = (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
                error: Error()
        ...
        lateUpdate(dt) {
          //相机跟随
          var position = (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            error: Error()
          }), Player) : Player).inst.getPosition();
...
//# sourceMappingURL=b2077046875790439c8f09fcc83a68ea89eb0d22.js.map