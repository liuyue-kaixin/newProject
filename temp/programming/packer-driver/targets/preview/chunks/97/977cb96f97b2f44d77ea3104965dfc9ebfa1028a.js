      ...
      _export("VMBase", VMBase = (_dec = help('https://gitee.com/dgflash/oops-framework/blob/master/doc/mvvm/VMBase.md'), ccclass(_class = _dec(_class = class VMBase extends Component {
        ...
        onLoad() {
          ...
          for (var i = 1; i < paths.length; i++) {
            ...
            if (p == '*') {
              var index = this.node.parent.children.findIndex(n => n === this.node);
              if (index <= 0) index = 0;
          ...
          if (pathArr.length >= 1) {
            for (var _i = 0; _i < pathArr.length; _i++) {
              ...
              for (var _i2 = 1; _i2 < _paths.length; _i2++) {
                ...
                if (_p == '*') {
                  var _index = this.node.parent.children.findIndex(n => n === this.node);
...
//# sourceMappingURL=977cb96f97b2f44d77ea3104965dfc9ebfa1028a.js.map