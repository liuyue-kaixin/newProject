System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var Base, WordArray, BufferedBlockAlgorithm, Base64, EvpKDFAlgo, Cipher, StreamCipher, BlockCipherMode, CBC, BlockCipher, CipherParams, SerializableCipher, PasswordBasedCipher, Pkcs7, OpenSSLFormatter, OpenSSLKdf;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EvpKDFAlgo = _unresolved_3.EvpKDFAlgo;
    }],
    execute: function () {
       ...
       */
      _export("Cipher", Cipher = class Cipher extends BufferedBlockAlgorithm {
        /**
      ...
      _export("StreamCipher", StreamCipher = class StreamCipher extends Cipher {
        constructor() {
          super(...arguments);
          this.blockSize = 1;
        }
      ...
      _export("BlockCipherMode", BlockCipherMode = class BlockCipherMode extends Base {
        /**
      ...
      _export("CBC", CBC = class CBC extends BlockCipherMode {});
      /**
       * CBC encryptor.
       */
      ...
      _export("BlockCipher", BlockCipher = class BlockCipher extends Cipher {
        constructor(xformMode, key, cfg) {
          /**
           * Configuration options.
           *
      ...
      _export("CipherParams", CipherParams = class CipherParams extends Base {
        /**
      ...
      _export("SerializableCipher", SerializableCipher = class SerializableCipher extends Base {
        /**
         * Encrypts a message.
         *
      ...
      _export("PasswordBasedCipher", PasswordBasedCipher = class PasswordBasedCipher extends SerializableCipher {
        /**
...
//# sourceMappingURL=3ea9497da3efd8cb7e39acf7e326a9ddd4b2df9f.js.map