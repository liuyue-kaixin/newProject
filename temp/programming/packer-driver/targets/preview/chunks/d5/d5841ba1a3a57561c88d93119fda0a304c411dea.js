      ...
      _export("demo3d", demo3d = (_dec = ccclass('demo3d'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(CCInteger), _dec5 = property(CCInteger), _dec6 = property(Vec3), _dec(_class = (_class2 = class demo3d extends Component {
        ...
        addObjects(num, prefab, mesh) {
          ...
          for (var i = 0; i < num; i++) {
            ...
            var object = node.getComponent(_crd && cObject === void 0 ? (_reportPossibleCrUseOfcObject({
              error: Error()
            }), cObject) : cObject);
        ...
        worldManager(dt) {
          ...
          var boxNum = Math.round((_crd && Config === void 0 ? (_reportPossibleCrUseOfConfig({
            error: Error()
          ...
          var sphereNum = Math.round((_crd && Config === void 0 ? (_reportPossibleCrUseOfConfig({
            error: Error()
...
//# sourceMappingURL=d5841ba1a3a57561c88d93119fda0a304c411dea.js.map